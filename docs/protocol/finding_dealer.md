...
In the system the cashier nodes are predetermined ones and this info is stored in the `cashier_nodes.json` file which is present at the path `/bet/poker/config`. And the contents of this file looks as below:
```
[{
