...
for src in src/*.c; do
  ...
  {
    "directory": "$(pwd)",
    "command": "gcc -g -fPIC -std=c99 -Iinclude -I../libs/crypto777 -I$EXTERNAL_DIR/includes/curl -I$EXTERNAL_DIR/dlg/include -I$EXTERNAL_DIR/iniparser/src -I$EXTERNAL_DIR/nng/include -I$EXTERNAL_DIR/jsmn -I$LIBINIPARSER_HEADERS -I$LIBWEBSOCKETS_HEADERS -I$LIBJSMN_HEADERS -I../includes/curl -c $src",
    "file": "$(pwd)/$src"
  }JSON
done
echo ""
